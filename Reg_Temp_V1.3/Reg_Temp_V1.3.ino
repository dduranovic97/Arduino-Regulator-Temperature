...
#define Sample_interval 250 /* uzima uzorak temperature odredjen intervalom*/
#define hyst 2 /*Histereza*/

/*Remote button codes*/
#define POWER 0x40BF00FF
#define OPTIONS 0x40BF20DF
#define TEMPUP 0x40BF609F
#define TEMPDOWN 0x40BFA05F
...
/************************************REGULATION**************************************************/
     ...
     if ((Thermistor(Uiz) < setT) || (stat == true && (Thermistor(Uiz) < setT + hyst))){
           stat = true;
           OFFtimerState = false;
      ...
      else if(Thermistor(Uiz) >= setT + hyst){                                                                                           
          stat = false;
          OFFtimerState = true;
